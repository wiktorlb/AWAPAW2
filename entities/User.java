...
public class User implements Serializable {
	...
	private List<UserHasGroup> userHasGroups1;

	//bi-directional many-to-one association to UserHasGroup
	@OneToMany(mappedBy="user2")
	private List<UserHasGroup> userHasGroups2;
	...
	public List<UserHasGroup> getUserHasGroups1() {
		return this.userHasGroups1;
	}
	...
	public UserHasGroup addUserHasGroups1(UserHasGroup userHasGroups1) {
		getUserHasGroups1().add(userHasGroups1);
		userHasGroups1.setUser1(this);

		return userHasGroups1;
	}

	public UserHasGroup removeUserHasGroups1(UserHasGroup userHasGroups1) {
		getUserHasGroups1().remove(userHasGroups1);
		userHasGroups1.setUser1(null);

		return userHasGroups1;
	}

	public List<UserHasGroup> getUserHasGroups2() {
		return this.userHasGroups2;
	}
	...
	public UserHasGroup addUserHasGroups2(UserHasGroup userHasGroups2) {
		getUserHasGroups2().add(userHasGroups2);
		userHasGroups2.setUser2(this);

		return userHasGroups2;
	}

	public UserHasGroup removeUserHasGroups2(UserHasGroup userHasGroups2) {
		getUserHasGroups2().remove(userHasGroups2);
		userHasGroups2.setUser2(null);
